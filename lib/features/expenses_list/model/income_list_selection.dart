...
/// Selected income ids on the income list (session UI state).
class IncomeListSelection extends Notifier<Set<int>> {
  @override
  Set<int> build() => {};
...
final incomeListSelectionProvider =
    NotifierProvider.autoDispose<IncomeListSelection, Set<int>>(
  IncomeListSelection.new,
);
