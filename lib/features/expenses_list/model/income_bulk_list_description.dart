...
/// Builds a centered multi-line list of income entries for bulk confirm descriptions.
String buildIncomeBulkListDescription(
  ...
  final preview = incomes.take(previewLimit).map((e) {
  ...
  final remaining = incomes.length - preview.length;
  if (remaining > 0) {
