...
/// Income-list chart view: loads slices or time-series then renders
/// [BreakdownChartView].
class IncomeChart extends StatelessWidget {
  final Future<IncomeChartAggregation>? slicesFuture;
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<IncomeChartAggregation>(
      future: slicesFuture,
      builder: (context, snap) {
        if (!snap.hasData) {
          return const Padding(
          ...
          if (missingRates > 0)
            Padding(
              ...
              child: MaterialBanner(
                ...
                content: Text(
                  l10n.chartMissingRatesAlertGeneric(missingRates),
                ),
                actions: [
                  TextButton(
