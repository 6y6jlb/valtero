...
class AppSettingsNotifier extends AsyncNotifier<AppSettings> {
  ...
  Future<void> setExpensesListDisplay({
    ...
    await _save(current.copyWith(
      ...
      expensesChartDatePeriod: chartDatePeriod,
    ));
  }
  ...
  Future<void> setGoogleDriveSync({
    ...
    DateTime? sharedLastSyncedAt,
    bool clearSharedLastSyncedAt = false,
    ...
    await _save(current.copyWith(
      ...
      googleDriveSharedLastSyncedAt: sharedLastSyncedAt,
      clearGoogleDriveSharedLastSyncedAt: clearSharedLastSyncedAt,
