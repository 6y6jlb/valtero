...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get guideSectionCashFlowBody =>
      'Вкладка «Баланс» сравнивает доходы и расходы. По умолчанию — кольцевая диаграмма (сумма доходов против суммы расходов); столбцы или линия — по дням, неделям, месяцам или годам (иконки под графиком). Горизонтальный жест по графику листает период. Фильтры по дате и валюте общие; категории и оплата остаются на вкладках «Расходы» и «Доходы».';
  ...
  String get guideSectionChartsBody =>
      'Круговая и другие диаграммы на дашборде разбивают траты по стране, способу оплаты, категории, периоду или валюте. Иконки под графиком (над легендой) переключают разбивку; по графику можно провести горизонтально. Горизонтальный жест вне графика переключает Баланс / Расходы / Доходы. Без страны, оплаты или категории — «не задано». Нажатие на сегмент открывает подходящие траты. Чип легенды скрывает/показывает долю. Под графиком — недавние траты и ссылка на полный список. «Показать траты» — список, группировка и график с сортировкой и страницами.';
